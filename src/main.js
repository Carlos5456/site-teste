...
document.querySelector('#app').innerHTML = `
    ...
    <div class="row justify-content-center w-100" style="max-width: 900px;">
      <div class="col-12 col-md-10">
        ...
        <div class="d-flex justify-content-center">
          <a class="btn btn-success btn-lg d-flex align-items-center gap-2 px-5 py-3 fw-bold shadow" href="https://wa.me/5541997357726?text=Ol%C3%A1%2C%20vim%20do%20site%2C%20tenho%20interesse%20no%20anuncio%3A%201016" target="_blank" rel="noopener">
  ...
  <a href="https://wa.me/5541997357726?text=Ol%C3%A1%2C%20vim%20do%20site%2C%20tenho%20interesse%20no%20anuncio%3A%201016" class="whatsapp-float" target="_blank" rel="noopener" aria-label="Fale no WhatsApp">
