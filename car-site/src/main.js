...
document.querySelector('#app').innerHTML = `
  <div class="container">
    ...
    <div class="car-images">
      <img src="./1.jpg" alt="Imagem do carro 1" class="car-image" />
      <img src="./2.jpg" alt="Imagem do carro 2" class="car-image" />
    </div>
    <ul class="car-details">
      <li><strong>Placa:</strong> TRE9087</li>
      <li><strong>Modelo:</strong> Fiat Pulse Audace</li>
      <li><strong>Ano:</strong> 2023</li>
      <li><strong>Preço:</strong> R$ 94.000</li>
      <li><strong>KM:</strong> 12.000</li>
      <li><strong>Opcionais:</strong> Alerta de Saída de Faixa, Frenagem de Emergência, GPS Nativo</li>
      <li><strong>Observações:</strong> Carro na garantia de fábrica. Primeira revisão feita.</li>
      <li><strong>Sinistro/Leilão:</strong> Nada consta</li>
    </ul>
    <div class="buttons">
      <a class="btn btn-whatsapp" href="https://wa.me/5541997357726?text=Oi%2C%20quero%20saber%20mais%20sobre%20o%20carro%20do%20anuncio%3A%201016" target="_blank" rel="noopener">
